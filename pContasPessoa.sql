	...
	begin
		...
		begin
			...
			begin
				delete
					#resu
				where
					ID IN (Select pfcc.ContaCorrenteID From PessoasFisicasTelefones pft inner join PessoasFisicasContasCorrentes pfcc on pft.PessoaFisicaID = pfcc.PessoaFisicaID Where NumeroTelefone <> @Telefone)
			end
			...
			begin
				delete
					#resu
				where
					ID IN (Select pjcc.ContaCorrenteID From PessoasJuridicasTelefones pjt inner join PessoasJuridicasContasCorrentes pjcc on pjt.PessoaJuridicaID = pjcc.PessoaJuridicaID Where NumeroTelefone <> @Telefone)
			end
		...
		begin
			...
			From PessoasFisicas pf WITH (nolock) INNER JOIN PessoasFisicasContasCorrentes pfcc WITH (nolock) ON
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE pf.ID IN (Select PessoaFisicaID From PessoasFisicasTelefones Where NumeroTelefone = @Telefone)
		...
		begin
			...
			From PessoasJuridicas pj WITH (nolock) INNER JOIN PessoasJuridicasContasCorrentes pjcc WITH (nolock) on
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE pj.ID IN (Select PessoaJuridicaID From PessoasJuridicasTelefones Where NumeroTelefone = @Telefone)
	...
	begin
		...
		begin
			...
			From PessoasFisicas pf WITH (nolock) INNER JOIN PessoasFisicasContasCorrentes pfcc WITH (nolock) ON
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE cc.CriadoEm Between @DataInicialAbertura AND @DataFinalAbertura
	...
	begin
		...
		begin
			...
			From PessoasFisicas pf WITH (nolock) INNER JOIN PessoasFisicasContasCorrentes pfcc WITH (nolock) ON
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE cc.DataPrimeiraCarga Between @DataInicialPrimeiraCarga AND @DataFinalPrimeiraCarga
	...
	begin
		...
		begin
			...
			begin
				delete
					#resu
				where
					ID IN (Select pfcc.ContaCorrenteID From PessoasFisicasEnderecos pfe Inner Join Estados e ON pfe.EstadoID = e.ID inner join PessoasFisicasContasCorrentes pfcc on pfe.PessoaFisicaID = pfcc.PessoaFisicaID Where e.Sigla <> @Estado)
			end --if (@TipoPessoa is null or @TipoPessoa = 'PF')
			...
			begin
				delete
					#resu
				where
					ID IN (Select pjcc.ContaCorrenteID From PessoasJuridicasEnderecos pje Inner Join Estados e ON pje.EstadoID = e.ID inner join PessoasJuridicasContasCorrentes pjcc on pje.PessoaJuridicaID = pjcc.PessoaJuridicaID Where e.Sigla <> @Estado)
			end --if (@TipoPessoa is null or @TipoPessoa = 'PJ')
		...
		begin
			...
			From PessoasFisicas pf WITH (nolock) INNER JOIN PessoasFisicasContasCorrentes pfcc WITH (nolock) ON
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE pf.ID IN (Select PessoaFisicaID From PessoasFisicasEnderecos pfe Inner Join Estados e ON pfe.EstadoID = e.ID Where e.Sigla = @Estado)
		...
		begin
			...
			From PessoasJuridicas pj WITH (nolock) INNER JOIN PessoasJuridicasContasCorrentes pjcc WITH (nolock) on
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE pj.ID IN (Select PessoaJuridicaID From PessoasJuridicasEnderecos pfe Inner Join Estados e ON pfe.EstadoID = e.ID Where e.Sigla = @Estado)
	...
	begin
		...
		begin
			...
			begin
				delete
					#resu
				where
					ID IN (Select pfcc.ContaCorrenteID From PessoasFisicasEnderecos pfe inner join PessoasFisicasContasCorrentes pfcc on pfe.PessoaFisicaID = pfcc.PessoaFisicaID Where Cidade not like '%' + @Cidade + '%')
			end --if (@TipoPessoa is null or @TipoPessoa = 'PF')
			...
			begin
				delete
					#resu
				where
					ID IN (Select pjcc.ContaCorrenteID From PessoasJuridicasEnderecos pje inner join PessoasJuridicasContasCorrentes pjcc on pje.PessoaJuridicaID = pjcc.PessoaJuridicaID Where Cidade not like '%' + @Cidade + '%')
			end --if (@TipoPessoa is null or @TipoPessoa = 'PJ')
		...
		begin
			...
			From PessoasFisicas pf WITH (nolock) INNER JOIN PessoasFisicasContasCorrentes pfcc WITH (nolock) ON
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE pf.ID IN (Select PessoaFisicaID From PessoasFisicasEnderecos Where Cidade like '%' + @Cidade + '%')
		...
		begin
			...
			From PessoasJuridicas pj WITH (nolock) INNER JOIN PessoasJuridicasContasCorrentes pjcc WITH (nolock) on
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE pj.ID IN (Select PessoaJuridicaID From PessoasJuridicasEnderecos Where Cidade like '%' + @Cidade + '%')
	...
	begin
		...
		begin
			...
			From PessoasFisicas pf WITH (nolock) INNER JOIN PessoasFisicasContasCorrentes pfcc WITH (nolock) ON
				...
				LEFT JOIN DadosSantanderContaCorrente AS dscc WITH (nolock) ON
					cc.ID = dscc.ContaCorrenteID
			WHERE cc.StatusCadastroID = (Select ID From StatusCadastro Where Status = @Validacao)
